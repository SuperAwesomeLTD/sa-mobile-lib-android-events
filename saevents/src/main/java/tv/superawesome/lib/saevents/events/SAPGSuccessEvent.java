...
public class SAPGSuccessEvent extends SAServerEvent {
    ...
    public SAPGSuccessEvent(Context context, SAAd ad, SASession session) {
        super(context, ad, session);
    }

    public SAPGSuccessEvent(Context context, SAAd ad, SASession session, Executor executor, int timeout) {
