...
public class SAMoatEvents2 {
    ...
    public SAMoatEvents2(Activity activity) {
    ...
    public String registerDisplayMoatEvent (WebView webView, HashMap<String, String> adDetails) {
    ...
    public boolean registerVideoMoatEvent (VideoView videoView, MediaPlayer mediaPlayer, HashMap<String, String> adDetails) {
