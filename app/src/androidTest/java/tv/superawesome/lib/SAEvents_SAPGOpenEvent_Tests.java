...
public class SAEvents_SAPGOpenEvent_Tests extends ActivityInstrumentationTestCase2<MainActivity> {

    public SAEvents_SAPGOpenEvent_Tests() {
    ...
    public void test1 () {
        ...
        SAPGOpenEvent event = new SAPGOpenEvent(context, ad, session);
        ...
        assertTrue(query.opt("data").toString().contains("type%22%3A%22parentalGateOpen"));
    ...
    public void test5 () throws Throwable {
        ...
        final SAPGOpenEvent event = new SAPGOpenEvent(context, ad, session);
