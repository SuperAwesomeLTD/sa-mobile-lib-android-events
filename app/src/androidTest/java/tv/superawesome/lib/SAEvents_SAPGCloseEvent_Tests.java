...
public class SAEvents_SAPGCloseEvent_Tests extends ActivityInstrumentationTestCase2<MainActivity> {

    public SAEvents_SAPGCloseEvent_Tests() {
    ...
    public void test1 () {
        ...
        SAPGCloseEvent event = new SAPGCloseEvent(context, ad, session);
        ...
        assertTrue(query.opt("data").toString().contains("type%22%3A%22parentalGateClose"));
    ...
    public void test5 () throws Throwable {
        ...
        final SAPGCloseEvent event = new SAPGCloseEvent(context, ad, session);
