...
public class SAEvents_SAPGFailEvent_Tests extends ActivityInstrumentationTestCase2<MainActivity> {

    public SAEvents_SAPGFailEvent_Tests() {
    ...
    public void test1 () {
        ...
        SAPGFailEvent event = new SAPGFailEvent(context, ad, session);
        ...
        assertTrue(query.opt("data").toString().contains("type%22%3A%22parentalGateFail"));
    ...
    public void test5 () throws Throwable {
        ...
        final SAPGFailEvent event = new SAPGFailEvent(context, ad, session);
